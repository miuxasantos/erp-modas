...
public class ContasReceberController {
    ...
    @PostMapping
    @Auditar(acao = TipoAcaoAud.CREATE, entidade = "contas_receber")
    ...
    @PreAuthorize(RoleAuthority.PROPRIETARIO)
    @PutMapping("/{id}")
    @Auditar(acao = TipoAcaoAud.UPDATE, entidade = "contas_receber")
    ...
    @PreAuthorize(RoleAuthority.PROPRIETARIO)
    @DeleteMapping("/{id}")
    @Auditar(acao = TipoAcaoAud.DELETE, entidade = "contas_receber")
